...
<html lang="en">
  <head>
	...
	<nav class="topnav" id="myTopnav">
            <a href="http://localhost/complaintmanagement/index.html" >Home</a>
            <a href="http://localhost/complaintmanagement/users/">User Login</a>
            <a href="http://localhost/complaintmanagement/users/registration.php" class="active">User Registration</a>
            <a href="http://localhost/complaintmanagement/admin/">admin</a>
